...
const FullscreenCanvas = forwardRef<HTMLDivElement, FullscreenCanvasProps>(
  (
    ...
    const handleNucleotideClickInternal = (
      e: React.MouseEvent,
      nucleotideId: number,
    ) => {
      if (mode === "feature") {
        ...
        return (
          <g key={nucleotide.id}>
            <circle
              ...
              onMouseDown={(e) =>
                mode !== "feature" && onNucleotideMouseDown(e, nucleotide.id)
              }
      ...
      >
        ...
        >
          ...
          >
            ...
            {mode === "feature" &&
              selectedFeatureNucleotides.map((id) => {
                  ...
                  {currentLabel === annotation.id && (
                    <g className="pointer-events-none">
                      <circle
                        cx={
                          annotation.x -
                          (annotation.text.length * annotation.font_size) / 4 -
                          8
                        }
                        cy={annotation.y - annotation.font_size / 2 - 8}
                        r="3"
                        fill="#9ca3af"
                      />
                      <circle
            ...
            >
              ...
              >
                ...
                <LabelForm
                  ...
                  initialFontSize={getCurrentLabel()?.font_size || 14}
