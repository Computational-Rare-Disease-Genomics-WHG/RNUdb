  ...
  return (
    <Card className="bg-white/95 backdrop-blur-sm border border-slate-200 shadow-xl shadow-slate-200/30 rounded-2xl">
      <CardHeader>
        ...
        <CardDescription>Recent publications on {currentGene}</CardDescription>
      </CardHeader>
      <CardContent>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      variant="outline"
                      className="text-xs bg-white border-slate-300 text-slate-700 font-mono"
                    >
                      DOI: {paper.doi}
                    </Badge>
                    <Button
                      size="sm"
                      variant="ghost"
                      className="h-6 px-2 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200"
                    >
