            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-sm text-slate-500 mb-4 max-w-sm mx-auto">
                  ...
                  position, ref, alt, hgvs, clinical_significance, zygosity
                </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    ...
                    {validationResult.total_count} rows valid
                  ...
                  <div className="max-h-48 overflow-y-auto divide-y divide-red-100">
                    {validationResult.errors.map((e: any, i: number) => (
                      <div key={i} className="px-4 py-3 flex items-start gap-3">
                        <span className="text-xs font-mono text-red-400 shrink-0 mt-0.5">
                          Row {e.row}
                        </span>
                ...
                <div className="border-2 border-amber-200 rounded-xl overflow-hidden">
                  ...
                  <div className="max-h-32 overflow-y-auto divide-y divide-amber-100">
                    {validationResult.warnings.map((w: any, i: number) => (
                      <div key={i} className="px-4 py-3 flex items-start gap-3">
                        <span className="text-xs font-mono text-amber-400 shrink-0 mt-0.5">
                          Row {w.row}
                        </span>
          ...
          {step === 4 && importResult && (
            <div className="text-center py-8">
              ...
              <p className="text-slate-500 mb-8 max-w-sm mx-auto">
                Successfully imported {importResult.imported_count} variants
                into {geneId}
                {importResult.skipped_count > 0 && (
                  <span>
                    . Skipped {importResult.skipped_count} invalid rows.
                  </span>
                )}
              </p>
