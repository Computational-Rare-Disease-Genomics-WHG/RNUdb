      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData({ ...formData, clinical_significance: value })
            }
          >
            <SelectTrigger>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, clinvar_significance: e.target.value })
            }
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, function_score: e.target.value })
            }
          />
        </div>
        <div>
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData({ ...formData, depletion_group: value })
            }
          >
            <SelectTrigger>
              <SelectValue placeholder="Select..." />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, gnomad_ac: e.target.value })
            }
          />
        </div>
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, gnomad_hom: e.target.value })
            }
          />
        </div>
      </div>
