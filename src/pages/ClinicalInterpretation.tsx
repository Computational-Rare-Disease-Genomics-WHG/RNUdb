...
const EXAMPLES = [
  {
    ...
    criteria: ["PS2_VeryStrong", "PS4", "PM1", "PS3_Mod"],
    reasoning: [
      ...
      "7/8,841 NDD probands vs 0/21,817 non-NDD (Fisher's P=1.7x10-4) (PS4)",
      "9 confirmed de novo observations in Nava et al. with phenotype consistent (PS2_VeryStrong)",
      "PP4: splicing signature and episignature shown for RNU4-2 [16] if tested",
    ],
  ...
  },
  {
    ...
    gene: "RNU2-2",
    variant: "n.8C>T",
    position: "chr11:62609274 G>A",
    inheritance: "De novo (interpreted for recessive NDD)",
    phenotype:
      "Absence seizures, ADHD, learning difficulties, mild developmental delay",
    classification: "VUS",
    criteria: ["PM3", "PM1", "PM2_supp"],
    reasoning: [
      "1 observation in trans with n.104T>G (Likely Pathogenic) in Jackson et al. — 1.0 pts (PM3)",
      "Variant in 5' region enriched for recessive NDD variants (PM1)",
      "Rare in population, no homozygous individuals identified (PM2_supp)",
      "If RNA-seq showed reduced RNU2-2 expression, could apply PP4",
    ],
  ...
  },
  {
    ...
    gene: "RNU4ATAC",
    variant: "n.37G>A",
    position: "chr2:121530916 G>A",
    inheritance: "Maternally inherited",
    phenotype: "Roifman syndrome (second variant in trans is VUS)",
    classification: "Pathogenic",
    criteria: ["PM3_strong", "PM1", "PM4", "PP1_mod", "PS3_supp"],
    reasoning: [
      "Located in 5' stem-loop region enriched for recessive NDD variants (PM1)",
      "3+ reports with LP/P variant in trans — 3 pts (PM3_strong)",
      "Segregation in 5 affected relatives from 2 families (PP1_mod)",
      "Equivalent variant RNU4-2:n.32G>A classified as Likely Pathogenic (PM5)",
      "Functional studies suggest impact on splicing efficiency, insufficient controls for above supporting (PS3_supp)",
      "PP4: RNA-seq could show elevated minor intron retention if tested",
    ],
    conclusion: "Pathogenic",
  },
  {
    ...
    gene: "RNU5B-1",
    variant: "n.44A>G",
    position: "chr15:65304720 A>G",
    inheritance: "De novo",
    phenotype: "Severe developmental delay and ocular abnormalities",
    classification: "Likely Pathogenic",
    criteria: ["PS2", "PM1", "PM2_supp"],
    reasoning: [
      "3 confirmed de novo occurrences in Nava et al. with phenotype consistent (PS2)",
      "Within constrained 5' stem loop I (PM1)",
      "Absent from population databases (PM2_supp)",
    ],
