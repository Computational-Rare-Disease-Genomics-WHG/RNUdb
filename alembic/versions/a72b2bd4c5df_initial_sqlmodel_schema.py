...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "entity_type IN ('gene', 'variant', 'literature', 'structure', 'bed_track')",  # noqa: E501
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "role IN ('guest', 'pending', 'curator', 'admin')", name="check_role"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "clinvar_significance", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "clinical_significance", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
