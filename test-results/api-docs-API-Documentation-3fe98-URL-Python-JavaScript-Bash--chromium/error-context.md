...
- Name: api-docs.spec.ts >> API Documentation Page >> should display code tabs (cURL, Python, JavaScript, Bash)
- Location: tests/e2e/api-docs.spec.ts:73:3
...
Locator: locator('button:has-text("cURL")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("cURL")')
