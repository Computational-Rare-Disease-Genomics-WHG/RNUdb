...
- Name: api-docs.spec.ts >> API Documentation Page >> should switch to Rate Limits tab
- Location: tests/e2e/api-docs.spec.ts:46:3
...
Call log:
  - waiting for locator('button:has-text("Rate Limits")')
