...
- Name: api-docs.spec.ts >> API Documentation Page >> should display tabs (Endpoints, Guides, Rate Limits)
- Location: tests/e2e/api-docs.spec.ts:18:3
...
Locator: locator('button:has-text("Endpoints")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Endpoints")')
