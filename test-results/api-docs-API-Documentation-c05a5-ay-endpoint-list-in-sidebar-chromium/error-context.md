...
- Name: api-docs.spec.ts >> API Documentation Page >> should display endpoint list in sidebar
- Location: tests/e2e/api-docs.spec.ts:27:3
...
Locator: locator('text=Endpoints').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Endpoints').first()
