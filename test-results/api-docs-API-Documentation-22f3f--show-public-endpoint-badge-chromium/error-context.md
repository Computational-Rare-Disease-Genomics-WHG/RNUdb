...
- Name: api-docs.spec.ts >> API Documentation Page >> should show public endpoint badge
- Location: tests/e2e/api-docs.spec.ts:83:3
...
Locator: locator('text=Public').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Public').first()
