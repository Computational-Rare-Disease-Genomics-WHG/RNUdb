...
- Name: api-docs.spec.ts >> API Documentation Page >> should switch to Guides tab
- Location: tests/e2e/api-docs.spec.ts:35:3
...
Call log:
  - waiting for locator('button:has-text("Guides")')
