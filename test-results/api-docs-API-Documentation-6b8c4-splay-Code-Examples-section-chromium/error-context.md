...
- Name: api-docs.spec.ts >> API Documentation Page >> should display Code Examples section
- Location: tests/e2e/api-docs.spec.ts:65:3
...
Locator: locator('text=Code Examples').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Code Examples').first()
