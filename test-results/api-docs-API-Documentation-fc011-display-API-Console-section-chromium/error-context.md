...
- Name: api-docs.spec.ts >> API Documentation Page >> should display API Console section
- Location: tests/e2e/api-docs.spec.ts:57:3
...
Locator: locator('text=API Console').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=API Console').first()
